 ...
 function initBoardInteractions() {
    ...
    * Safe to call multiple times; listeners are added once using a guard flag.
    */
   const cells = Array.from(document.querySelectorAll('.cell'));
   cells.forEach((cell) => {
     if (cell.dataset.listenersAttached === 'true') return;
 ...
 // Initialize on DOM ready (guard against non-browser environments)
